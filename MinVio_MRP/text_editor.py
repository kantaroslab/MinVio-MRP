        ...
        with open(waypoint_folder_location+"/uav"+str(robot+1)+"_test.txt", 'w') as f:
            ...
            for i in range(0,len(path[0][1])):
                if i<len(path[0][1])-1:
                    ...
                    for di in range(discretization):
                        if i==0 and di==0:
                            ...
                            if path[0][1][i][1]!=path[0][1][i-1][1] and new_wp:
                                new_wp = False
                                rob_wp_satsify_AP.append([path[0][1][i][0][robot][0]+dx*di, path[0][1][i][0][robot][1]+dy*di, path[0][1][i][1], targets[i],i*discretization])
                    ...
                    rob_wp_satsify_AP.append([path[0][1][i][0][robot][0], path[0][1][i][0][robot][1], path[0][1][i][1], targets[i],i*discretization])
